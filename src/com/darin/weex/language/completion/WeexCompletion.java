package com.darin.weex.language.completion;
 ...
 */
public class WeexCompletion extends CompletionContributor {
    ...
    public WeexCompletion() {
        extend(CompletionType.BASIC, psiElement(), new EmmetAbbreviationCompletionProvider());
