 ...
 */
public class WeexSplitEditorToolbar extends JPanel implements Disposable {
    private static final String LEFT_TOOLBAR_GROUP_ID = "Weex.Toolbar.Left";
    private static final String RIGHT_TOOLBAR_GROUP_ID = "Weex.Toolbar.Right";
    ...
    public WeexSplitEditorToolbar(@NotNull final JComponent targetComponentForActions) {
    ...
    private class MySpacingPanel extends JPanel {
